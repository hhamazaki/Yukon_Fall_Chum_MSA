...
```
Figure 1.  Daily sonar counts attributed to chum salmon (bars) showing genetic sampling time frames (droplines), project operated near Pilot Station, Yukon Area, 2021.
...
# Base plot 			
par(mfrow=c(1,1),mar=c(5.1, 4.1, 4.1, 4.1),yaxs='i',bty='l',las=1) 
temp1 <- Pilot.stpl[Pilot.stpl$group==ststockID[1],]
plot(order(temp1$Strata),type='n', xlim=c(1,5),ylim=c(0,100), ylab='Stock Percent',xlab='Sample Strata Number')
for (i in 1:6){
...
```
Figure 2.  Mean proportion of chum salmon stock groups by sampling strata, Yukon Area, 2021.
...
```
Figure 3.  Mean proportion of chum salmon stock groups by standard sampling strata, Yukon Area, 2004-2020.
...
```
Figure 4.  Minimum and maximum (2004-2020) and 2021 mean stock proportion by standard sampling strata, comparing the major chum salmon components, Yukon Area.
```{r,fig.width=9, fig.height = 9,echo=FALSE,dpi=400}
...
```
Figure 5.  Crossover of summer and fall chum salmon based on genetic stock analysis (standard sampling strata), Yukon Area, 1999-2002 using allozymes and 2004-2021 using microsatellites.
```{r,fig.width=9, fig.height = 9,echo=FALSE,dpi=400}
  par(mfrow=c(5,5),mar = c(2,2,2,2),oma = c(3,3,3,3),yaxs='i',bty='l') 
    for(i in 1:ny){
    temp <- with(Pilot.hsft, Pilot.hsft[Year==years[i],])
...
```
Figure 6.  Crossover of summer and fall chum salmon (3 periods) based on genetic stock analysis (standard sampling strata), Yukon Area, 1999-2002 using allozymes and 2004-2021 using microsatellites.
```{r,fig.width=9, fig.height = 9,echo=FALSE,dpi=400}
...
```
Figure 7. Contributions of chum salmon based on genetic analysis during the fall season (July 19 to end of season), sampled at the mainstem sonar operated near Pilot Station, Yukon Area, 2021.