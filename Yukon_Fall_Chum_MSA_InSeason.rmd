...
s.names <- with(rstr,paste(paste('Strata',Strata),Time_Frames,paste('n=',Sample_Size),sep='<br/>'))
t.names <-c('Stock',s.names)
kable(n[,-1],digits=0,caption=paste("Genetic Proportions of chum salmon stock grouping used to converst Pilot Station passage estimates to numbers of fish","this.year"),format = "html",, booktabs = T,longtable=T,col.names=t.names,format.args = list(big.mark = ",",scientific = F),escape=FALSE) %>%
